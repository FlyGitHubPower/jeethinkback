...
public class SysFlowForm implements Serializable {
    private static final long serialVersionUID = 257165025016408953L;
    /**
     * 表单id
     */
    private String id;
    ...
    public void setHtmlfrom(String htmlfrom) {
    ...
    public String getUsingdep() {
        return usingdep;
    }

    public void setUsingdep(String usingdep) {
        this.usingdep = usingdep;
    }
